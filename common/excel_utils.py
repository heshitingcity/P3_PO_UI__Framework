...
if __name__ == '__main__':
    ...
    testcase_data_path = os.path.join(current_path,'..',local_config.testdata_path)
    sheet_infos = ExcelUtils(testcase_data_path,'main_suite').get_sheet_data_by_list()
    print( sheet_infos )
    for data in sheet_infos:
        print(data)
